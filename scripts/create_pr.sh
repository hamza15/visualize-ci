...
curl -X PUT -H "Accept: application/vnd.github.v3+json" -H "Authorization: token $TOKEN" https://api.github.com/repos/$OWNER/$REPO/contents/dev/$FILE -d '{\"message\":\"Harness Updating '$FILE'\",\"content\":\"'$TEMPLATE_BLOB'\", \"sha\": \"'$CONTENTS_SHA'\", \"branch\": \"'$BRANCH_NAME'\"}'
